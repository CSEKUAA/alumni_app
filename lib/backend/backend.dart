...
import 'schema/csekuaa_record.dart';
...
export 'schema/csekuaa_record.dart';
...
/// Functions to query CsekuaaRecords (as a Stream and as a Future).
Future<int> queryCsekuaaRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      CsekuaaRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<CsekuaaRecord>> queryCsekuaaRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      CsekuaaRecord.collection,
      CsekuaaRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<CsekuaaRecord>> queryCsekuaaRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<CsekuaaRecord>> queryCsekuaaRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
