...
class LightModeTheme extends AppThemeManager {
  @Deprecated('Use primary instead')
  Color get primaryColor => primary;
  @Deprecated('Use secondary instead')
  Color get secondaryColor => secondary;
  ...
  late Color transparantcolor = Color(0xFFE38305);
}
...
class DarkModeTheme extends AppThemeManager {
  @Deprecated('Use primary instead')
  Color get primaryColor => primary;
  @Deprecated('Use secondary instead')
  Color get secondaryColor => secondary;
