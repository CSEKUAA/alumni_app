...
Widget wrapWithModel<T extends ModelWrapper>({
  required T model,
...
T createModel<T extends ModelWrapper>(
...
class DynamicModelManager<T extends ModelWrapper> {
  DynamicModelManager(this.defaultBuilder);
